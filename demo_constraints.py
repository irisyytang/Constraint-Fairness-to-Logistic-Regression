...
def test_adult_data():
	...
	train_fold_size = 0.7 #split the trianing and testing sets by 7:3
	...
	# loss_function = ada._adaboost_loss #tried to implement adaboost classifier
	sensitive_attrs = ["sex"]
