...
def check_data_file(fname):
    #os.chdir('/content/gdrive/My Drive/MIE424project/Code/')
...
def load_adult_data(load_data_size=None):
    ...
    """trans sensitive attributes data into """
    ...
    for f in data_files:
        ...
        for line in open(f, 'r'):
            ...
            # create binary labels of income level
            class_label = line[-1]
